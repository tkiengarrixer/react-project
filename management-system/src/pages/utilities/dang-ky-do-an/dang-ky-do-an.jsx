import { Typography, Select, Space, Form, Input, Button, ConfigProvider, Tooltip, message, Alert } from "antd";
...
function RegisterProject() {
    ...
    return <>
        {contextHolder}
        <Typography.Title level={4} style={{ fontWeight: "bold", marginTop: "0", marginBottom: "16px", borderBottom: "1px solid var(--active-color)" }}>Đăng ký đồ án tốt nghiệp</Typography.Title>
        ...
        <div className="form-container">
            ...
            >
                ...
                <Space className="input-container" size={[16, 0]}>
                    ...
                    >
                        <Input placeholder="Nhập tên đồ án" />
                    </Form.Item>
                    ...
                    <Form.Item
                        ...
                        className="form-item-input"
                    >
                        <Input placeholder="Nhập từ khoá chính" />
                    </Form.Item>
                </Space>
                ...
                <div className="textarea-container">
                    ...
                    <Form.Item
                        ...
                        className="form-item-textarea"
                    >
                        <TextArea placeholder="Nhập mong muốn" />
                    </Form.Item>
